...
class QualityPlugin(Plugin):
    ...
    qualities = [
        ...
        {'identifier': 'dvdrip', 'size': (600, 7000), 'median_size': 1800, 'label': 'DVD-Rip/DVDScr', 'width': 720, 'alternative': [('dvd', 'rip'), 'DVDSCR', 'DVDScr', 'WEBRip', 'WEBRIP' , 'WEB-DL', 'HRRip' ], 'allow': ['scr', 'dvd-r', '720p'], 'ext':['avi','xvid'], 'tags': [('dvd', 'rip'), ('dvd', 'xvid'), ('dvd', 'divx
        {'identifier': 'scr', 'size': (600, 4000), 'median_size': 1200, 'label': 'Screener', 'width': 720, 'alternative': ['DVDSCR', 'DVDScr','screener', 'dvdscr', 'ppvrip', 'dvdscreener', 'hdscr', 'webrip', 'WEBRip', 'WEBRIP' , 'WEB-DL'], 'allow': ['dvdr', 'dvd-r', 'dvdrip', '720p', '1080p'], 'ext':['avi','xvid'], 'tags': [('dvd', 'rip'), ('dvd', 'xvid'), ('dv
