...
class QualityPlugin(Plugin):
    ...
    qualities = [
        ...
        {'identifier': 'scr', 'size': (600, 4000), 'median_size': 1200, 'label': 'Screener', 'width': 720, 'alternative': ['DVDSCR', 'DVDScr','screener', 'dvdscr', 'ppvrip', 'dvdscreener', 'hdscr', 'webrip', 'WEBRip', 'WEBRIP' , 'WEB-DL' ], 'allow': ['dvdr', 'dvd-r', 'dvdrip', '720p', '1080p'], 'ext':['avi','xvid'], 'tags': []},
