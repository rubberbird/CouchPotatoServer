...
class QualityPlugin(Plugin):
    ...
    qualities = [
        ...
        {'identifier': 'dvdrip', 'size': (600, 2400), 'median_size': 1500, 'label': 'DVD-Rip/DVDScr', 'width': 720, 'alternative': [('dvd', 'rip'), 'DVDSCR', 'DVDScr', 'WEBRip', 'HRRip' ], 'allow': ['scr', 'dvd-r'], 'ext':['avi'], 'tags': [('dvd', 'rip'), ('dvd', 'xvid'), ('dvd', 'divx')]},
        {'identifier': 'scr', 'size': (600, 1600), 'median_size': 700, 'label': 'Screener', 'alternative': ['DVDSCR', 'DVDScr','screener', 'dvdscr', 'ppvrip', 'dvdscreener', 'hdscr', 'webrip', ('web', 'rip')], 'allow': ['dvdr', 'dvd-r', 'dvdrip', '720p', '1080p'], 'ext':[], 'tags': [('dvd', 'rip'), ('dvd', 'xvid'), ('dvd', 'divx')]},
